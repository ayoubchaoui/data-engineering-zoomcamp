...
output "email" {
  value       = 328879620298-compute@developer.gserviceaccount.com
...
# private key
output "private_key" {
  value     = google_service_account_key.meto-sa-key.private_key
...
output "decoded_private_key" {
  value     = base64decode(google_service_account_key.meto-sa-key.private_key)
  sensitive = true
}
