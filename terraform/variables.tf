locals {
  data_lake_bucket = "meto_data_lake"
...
variable "gce_ssh_user" {
  default = "ayoub"   # adjust to preference
}
...
variable "account_id" {
  ...
  default =  "meto-analytics-project-01"
}
