SELECT NEIGHBOURHOOD_158,
  COUNTIF(REPORT_YEAR = 2021) AS car_theft_2020,
  COUNTIF(REPORT_YEAR = 2021) AS car_theft_2021,
  COUNTIF(REPORT_YEAR = 2022) AS car_theft_2022,
  FORMAT('%3.2f', (COUNTIF(REPORT_YEAR = 2021) - COUNTIF(REPORT_YEAR = 2020)) / COUNTIF(REPORT_YEAR = 2020)*100) AS pct_change_2021_to_2022,
  FORMAT('%3.2f', (COUNTIF(REPORT_YEAR = 2022) - COUNTIF(REPORT_YEAR = 2021)) / COUNTIF(REPORT_YEAR = 2021)*100) AS pct_change_2021_to_2022
FROM
  `final-project-zoomcamp.crime_data_all.crime_data`
WHERE
  OFFENCE = 'Auto Theft'
